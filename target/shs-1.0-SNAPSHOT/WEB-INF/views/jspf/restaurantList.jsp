...
<c:forEach items="${allRestaurants}" var="restaurant">
    <div class="well col-md-9 pull-left">
        <form action="/events/${restaurant.getId()}">
            ...
            <a class="btn btn-primary pull-right" style=" background-image: linear-gradient(to bottom,#28B7FF,#3573D0)" href="/events/event_${eventId}/restaurant_${restaurant.getId()}">Go to menu</a>
        </form>
    </div>
</c:forEach>
